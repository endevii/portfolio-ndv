...
export default function Education() {
  ...
  return (
    ...
    >
      <h1 className="text-2xl lg:text-3xl px-6 lg:p-0">Education</h1>
      <motion.div
      ...
      >
        ...
        {visible && (
          <div>
            <h1 className="text-2xl text-left px-4 pb-2">
            ...
            <motion.div
              ...
              className="flex flex-col align-middle justify-center m-2 rounded-md bg-gray-200 dark:bg-zinc-500 px-4 pb-4 border-black bg-opacity-50 backdrop-blur-sm drop-shadow-md border-2 dark:bg-opacity-50"
            >
              <div className="flex flex-row justify-between">
                ...
                <div className="flex flex-col align-middle justify-center m-5 border-black border-2 p-2 rounded-md bg-gray-200 bg-opacity-25 backdrop-blur-sm drop-shadow-md dark:bg-zinc-400 dark:bg-opacity-30">
                  ...
                  <p className="text-lg text-left">Expected Grad: May 2024</p>
                </div>
              </div>
              <div>
